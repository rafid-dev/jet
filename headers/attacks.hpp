...
namespace chess {
    ...
    private:
        ...
        static constexpr inline Bitboard _kingAttacks(Square s) {
            ...
            return b.shift<Direction::NORTH>() | b.shift<Direction::SOUTH>() | b.shift<Direction::EAST>() | b.shift<Direction::WEST>() | b.shift<Direction::NORTH_EAST>() | b.shift<Direction::NORTH_WEST>() |
                   b.shift<Direction::SOUTH_EAST>() | b.shift<Direction::SOUTH_WEST>();
        }
        ...
        struct MagicEntry {
            ...
            constexpr std::size_t index(U64 blockers) const {
                return ((blockers & mask) * magic) >> offset;
            }
        };
        ...
        static inline void generateSlidersAttacks(Square sq, std::array<MagicEntry, NUM_SQUARES>& magicTable, U64 magic, F attacks) {
            Bitboard edgesMask = ((Bitboard(Rank::RANK_1) | Bitboard(Rank::RANK_8)) & ~Bitboard(sq.rank())) | ((Bitboard(File::FILE_A) | Bitboard(File::FILE_H)) & ~Bitboard(sq.file()));
            ...
            if (sq < (NUM_SQUARES - 1)) {
                magicTable[sq + 1].table = magicTable[sq].table + (1ULL << bitops::popcount(magicTable[sq].mask));
            }
