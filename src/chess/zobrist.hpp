...
namespace chess {
    ...
    private:
        // clang-format off
        static constexpr inline std::array<U64, 781> RandomArray = {
        ...
        static inline constexpr std::array<U64, 16> castlingKeys = {
            0,
            RandomArray[768],
            RandomArray[768 + 1],
            RandomArray[768] ^ RandomArray[768 + 1],
            RandomArray[768 + 2],
            RandomArray[768] ^ RandomArray[768 + 2],
            RandomArray[768 + 1] ^ RandomArray[768 + 2],
            RandomArray[768] ^ RandomArray[768 + 1] ^ RandomArray[768 + 2],
            RandomArray[768 + 3],
            RandomArray[768] ^ RandomArray[768 + 3],
            RandomArray[768 + 1] ^ RandomArray[768 + 3],
            RandomArray[768] ^ RandomArray[768 + 1] ^ RandomArray[768 + 3],
            RandomArray[768 + 3] ^ RandomArray[768 + 2],
            RandomArray[768 + 3] ^ RandomArray[768 + 2] ^ RandomArray[768],
            RandomArray[768 + 1] ^ RandomArray[768 + 2] ^ RandomArray[768 + 3],
            RandomArray[768 + 1] ^ RandomArray[768 + 2] ^ RandomArray[768 + 3] ^ RandomArray[768]
        };
        // clang-format on

        static constexpr int PieceMap[12] = {1, 3, 5, 7, 9, 11, 0, 2, 4, 6, 8, 10};

    public:
        static inline constexpr U64 pieceKey(Piece piece, Square sq) {
            return RandomArray[PieceMap[static_cast<int>(piece)] * 64 + sq];
        }

        static inline constexpr U64 enpassantKey(File file) {
            return RandomArray[772 + static_cast<int>(file)];
        }

        static inline constexpr U64 castlingKey(int castling) {
            return castlingKeys[castling];
        }

        static inline constexpr U64 castlingIndex(int index) {
            return RandomArray[768 + index];
        }

        static inline constexpr U64 sideKey() {
            return RandomArray[780];
        }
    };
} // namespace chess